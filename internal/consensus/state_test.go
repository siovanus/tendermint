...
func TestStateOversizedBlock(t *testing.T) {
	...
	ensureNewTimeout(t, timeoutProposeCh, height, round, cs1.state.ConsensusParams.Timeout.ForPropose(round).Nanoseconds())
...
func TestStateLock_NoPOL(t *testing.T) {
	...
	*/
	...
	ensureNewTimeout(t, timeoutWaitCh, height, round, cs1.state.ConsensusParams.Timeout.ForVote(round).Nanoseconds())
...
func TestWaitingTimeoutProposeOnNewRound(t *testing.T) {
	...
	ensureNewTimeout(t, timeoutWaitCh, height, round, cs1.state.ConsensusParams.Timeout.ForPropose(round).Nanoseconds())
...
func TestStartNextHeightCorrectlyAfterTimeout(t *testing.T) {
	...
	ensureNewTimeout(t, timeoutProposeCh, height+1, round, cs1.state.ConsensusParams.Timeout.ForPropose(round).Nanoseconds())
	rs = cs1.GetRoundState()
	assert.False(
		t,
